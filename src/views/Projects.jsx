  ...
  <>
    ...
    <Divider speed={0.1} offset={offset} factor={2}>
      <UpDown>
        ...
        <SVG icon="upDown" width={8} fill={colors.grey} left="70%" top="20%" />
      ...
      <UpDownWide>
        <SVG icon="arrowUp" hiddenMobile width={16} fill={colors.grey} left="20%" top="90%" />
        <SVG icon="triangle" width={12} stroke={colors.white} left="90%" top="30%" />
        <SVG icon="circle" width={16} fill={colors.grey} left="70%" top="90%" />
        <SVG icon="triangle" hiddenMobile width={16} stroke={colors.grey} left="18%" top="75%" />
      ...
      <SVG icon="circle" width={12} fill={colors.grey} left="80%" top="60%" />
      <SVG icon="box" width={6} fill={colors.grey} left="10%" top="10%" />
      <SVG icon="box" width={12} fill={colors.grey} left="29%" top="26%" />
